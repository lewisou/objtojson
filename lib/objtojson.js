(function(){
  ...
  testNode = function(){
    var test;
    test = Generator.gen().node('fakeprop', function(empty){
      return 'a fake value';
    }).node('fakeprop2', function(empty){
      return 'a fake value 2';
    }).dict();
    return objEqual(test, {
      fakeprop: 'a fake value',
      fakeprop2: 'a fake value 2'
    });
  };
  testChildren = function(){
    var test;
    test = Generator.gen(obj).children('prop4', function(ele){
      return ele.attributes('prop1', 'prop3');
    }).dict();
    return objEqual(test, {
      prop4: [
        {
